...
class RopeJointGizmo extends JointGizmo {
    ...
    createToolGroup() {
        ...
        return o.plot = (r => {
            r.distance ? (e.plot(r.anchor.x, r.anchor.y, r.connectedAnchor.x, r.connectedAnchor.y), t.plot(r.anchor.x, r.anchor.y, r.distance.x, r.distance.y), t.style("stroke-dasharray", Tools.dashLength([5, 3])), c.center(r.distance.x, r.distance.y), o.show()) : o.hide()
        }), o
    }
    createArgs() {
        ...
        if (this.target.connectedBody) {
            ...
            e.tx = e.ty = 0;
            let t = cc.v2(cc.pointApplyAffineTransform(this.target.maxLength, 0, e)).mag(),
