...
let AssetDB = {
    ...
    import(e, s, t, a) {
        Editor.Ipc.sendToMain("asset-db:import-assets", e, s, t, a, -1)
    },
    create(e, s, t) {
        Editor.Ipc.sendToMain("asset-db:create-asset", e, s, t)
    },
    move(e, s, t, a) {
        Editor.Ipc.sendToMain("asset-db:move-asset", e, s, t, a)
    },
    delete(e, s) {
...
const Meta = Editor.require("app://asset-db/lib/meta");
Editor.metas || (Editor.metas = {}), Editor.metas["raw-asset"] = Meta.RawAssetMeta, Editor.metas.asset = Meta.AssetMeta, Editor.metas.folder = Meta.FolderMeta, Editor.assetdb = AssetDB;